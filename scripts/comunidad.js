...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // -------- Comunidad: todas las reseñas aprobadas, desde Supabase --------
  ...
  function renderCommunityGrid() {
    ...
    var reviews = window.TALAY_REVIEWS || [];
        ...
        '<div class="community-card">' +
          ...
          '<div class="community-card-body">' +
            ...
            '<div class="review-person">' +
              ...
              '<div><span class="name">' + review.customer_name + '</span>' +
                (dateLabel ? '<span class="role">' + dateLabel + '</span>' : '') +
              '</div>' +
            '</div>' +
          '</div>' +
        '</div>'
  ...
  document.addEventListener('talay:reviews-ready', renderCommunityGrid);
});